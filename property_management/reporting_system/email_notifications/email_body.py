...
<body>
    ...
    <div class="container">
        <h1 style="color: rgb(4, 58, 145)">Ticket #{artifacts['ticket_num']} was created</h1>
        <p>Dear Owner/Management,</p>
        <p>{artifacts['username']} has created the following issue.</p>
        </br>
        <p>Issue: {artifacts['issue']}</p>
        <p>Created on: {artifacts['date']}</p>
