...
from property_management.reporting_system.email_notifications.update_ticket_email_body import email_body
load_dotenv()


class UpdateTicket_email_notification():
    ...
    def send_mail(self): # Verification email - change name
        ...
        message["Subject"] = f"HP Management - {self.username} Updated a ticket"
