...
<body>
    ...
    <div class="container">
        ...
        <a href="https://helixpropertymanagement-718e761927a1.herokuapp.com/admin/verify-accout/{artifacts['hash_code']}/{artifacts['account']}/{artifacts['token']}" class="cta-button">Verify Account</a>
